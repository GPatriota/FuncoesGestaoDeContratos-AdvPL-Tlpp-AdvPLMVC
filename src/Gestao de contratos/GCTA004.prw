...
Function U_GCTA004
    ...
    Private cCadastro := 'Encerramento de medicoes'
    ...
    aadd(aCampos,{"Z53_TIPO"  ,,"Tipo Contrato" ,getSx3Cache("Z53_NUMERO", "X3_PICTURE")})
    aadd(aCampos,{"Z53_NUMMED",,"Numero Medicao",getSx3Cache("Z53_NUMERO", "X3_PICTURE")})
    aadd(aCampos,{"Z53_EMISSA",,"Dt emissao"    ,getSx3Cache("Z53_NUMERO", "X3_PICTURE")})
    ...
    markbrow(cAliasTmp,"MARK","U_GCTA0045()",aCampos,.F.,cMarca)
    oTempTable:delete()

Return

/*/{Protheus.doc} U_GCTA0045
    (long_description)
    @type  Function
    @author Gustavo Patriota
