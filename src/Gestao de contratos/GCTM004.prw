...
Function U_GCTB004
    ...
    Private cCadastro := 'Encerramento de medicoes (ADVPL MVC)'
    ...
    aadd(aCampos,{"Tipo Contrato" ,"Z53_TIPO"  ,"C",tamSX3("Z53_TIPO")[1]  , tamSX3("Z53_TIPO")[2]    ,getSx3Cache("Z53_NUMERO", "X3_PICTURE")})
    aadd(aCampos,{"Numero Medicao","Z53_NUMMED","C",tamSX3("Z53_NUMMED")[1], tamSX3("Z53_NUMMED")[2]  ,getSx3Cache("Z53_NUMERO", "X3_PICTURE")})
    aadd(aCampos,{"Dt emissao"    ,"Z53_EMISSA","D",tamSX3("Z53_EMISSA")[1], tamSX3("Z53_EMISSA")[2]  ,getSx3Cache("Z53_NUMERO", "X3_PICTURE")})
